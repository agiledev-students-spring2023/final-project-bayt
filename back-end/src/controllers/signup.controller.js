...
async function signup(req, res) {
    ...
    try {
        ...
        try {
            const user = await new userModel({ username: username, first_name: "Set your first name", last_name: "Set your last name", email: email, password: code, role: role, profile_pic: "Default.svg", houses: [house] }).save();
